                        ...
                        <div class="col-lg-2">
                         ...
                         <div class="col-lg-2">
                           ...
                           <div class="col-lg-3">
                            <div class="form-group">
                                <label>Asesor</label>
                                <input type="text" name="asesor" id="asesor" class="form-control" placeholder="Ingrese el nombre del asesorr "  required >
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese el NIT o Nombre del Proveedor" name="nombre" id="nombre" class="form-control">
                    </div>
                      <div class="form-group">
